...
//------------------------------------------------------------------------------------------------------------
void AActive_Brick::Set_Up_Colors()
{
	int mas_step = Max_Fade_Step - 1;

	for (int i = 0; i < Max_Fade_Step; i++)
	{
		Get_Fading_Color(AsConfig::Blue_Brick_Stick, i, Fading_Blue_Brick_Pens[i], Fading_Blue_Brick_Brushes[i]);

		Get_Fading_Color(AsConfig::Red_Brick_Stick, i, Fading_Red_Brick_Pens[i], Fading_Red_Brick_Brushes[i]);
	}
}
//------------------------------------------------------------------------------------------------------------
